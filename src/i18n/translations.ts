...
const pt: T = {
  ...
  comissao: {
    ...
    staffBios: {
      ...
      4: "Cuida da imagem e da comunicação do Brasil. Responsável pelas redes sociais, conteúdo e parcerias que levam o nome do clube além de campo.",
      5: "Apoia a diretoria na gestão do clube. Ajuda a manter a estrutura organizada e a equipe unida dentro e fora de campo.",
...
const en: T = {
  ...
  comissao: {
    ...
    staffBios: {
      ...
      4: "Looks after Brasil's image and communication. Responsible for social media, content and partnerships that carry the club's name beyond the pitch.",
      5: "Supports the board in running the club. Helps keep the structure organised and the team united on and off the pitch.",
...
const fr: T = {
  ...
  comissao: {
    ...
    roles: {
      ...
      "Diretor de Marketing": "Directeur Marketing",
      "Vice-Diretor": "Vice-Directeur",
    ...
    staffBios: {
      ...
      4: "Soigne l'image et la communication de Brasil. Responsable des réseaux sociaux, du contenu et des partenariats qui portent le nom du club au-delà du terrain.",
      5: "Soutient la direction dans la gestion du club. Aide à maintenir la structure organisée et l'équipe unie sur et en dehors du terrain.",
...
const nl: T = {
  ...
  comissao: {
    ...
    roles: {
      ...
      "Diretor de Marketing": "Marketingdirecteur",
      "Vice-Diretor": "Vicedirecteur",
      Treinador: "Trainer",
    },
    staffBios: {
      ...
      4: "Verzorgt het imago en de communicatie van Brasil. Verantwoordelijk voor sociale media, content en partnerships die de naam van de club verder dragen dan het veld.",
      5: "Ondersteunt het bestuur bij het runnen van de club. Helpt de structuur georganiseerd en het team verenigd te houden op en naast het veld.",
