...
export function Footer() {
  ...
  return (
    <footer className="w-full bg-ink border-t border-white/10">
        ...
        <div className="flex items-center gap-5">
          ...
          >
            <svg
              ...
              width="22"
              height="22"
              className="fill-white/60 group-hover:fill-secondary-fixed transition-colors"
              aria-hidden="true"
            >
            ...
            <span className="font-label-lg text-label-lg text-white/60 group-hover:text-secondary-fixed transition-colors">
              INSTAGRAM
            </span>
          </a>
